...
// through normalizeCard (fresh ids, validated values).
//
      ...
      cards: [
        {
          ...
          elements: [
            text({ y: 12, text: "WEEKLY INSIGHT", fontSize: 26, color: "#7dd3fc" }),
            bar({ y: 17.5, color: "#7dd3fc" }),
            text({ y: 26, text: T("성장하는 팀은\n회고부터 다르다", "Great teams run\nretros differently"), fontSize: 92, fontWeight: 800, lineHeight: 1.22 }),
            text({ y: 62, text: T("실리콘밸리 팀들이 매주 반복하는\n회고 루틴 3가지", "3 retro rituals top teams\nrepeat every single week"), fontSize: 34, fontWeight: 400, color: WHITE_70, lineHeight: 1.5 }),
            text({ y: 92, text: "@yourhandle", fontSize: 24, fontWeight: 600, color: WHITE_50 }),
          ],
        },
        {
          background: DIM.insight(0.88, 0.72, 0.9),
          elements: [
            text({ y: 8, text: "01", fontSize: 120, fontWeight: 900, color: "#7dd3fc", lineHeight: 1 }),
            text({ y: 32, text: T("잘한 것부터 말한다", "Start with the wins"), fontSize: 66, fontWeight: 800 }),
            text({ y: 50, text: T("문제 지적으로 시작하면 팀이 방어적이 됩니다.\n성과를 먼저 확인하고 개선점으로 넘어가세요.", "Open with problems and people get defensive.\nCelebrate what worked, then move to fixes."), fontSize: 38, fontWeight: 400, color: WHITE_70, lineHeight: 1.6 }),
        ...
        },
        {
          ...
          elements: [
            text({ y: 36, text: T("다음 회고에\n바로 써보세요", "Try it in your\nnext retro"), fontSize: 78, fontWeight: 800, lineHeight: 1.3 }),
            text({ y: 64, text: T("저장해두고 팀 채널에 공유 →", "Save this & share with your team →"), fontSize: 36, fontWeight: 400, color: WHITE_70 }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          elements: [
            text({ y: 11, text: "DAILY BRIEFING", fontSize: 25, fontWeight: 800, color: "#ff4d6d" }),
            bar({ y: 16.5, w: 10, h: 0.6, color: "#ff4d6d" }),
            text({ y: 25, text: T("오늘 꼭 알아야 할\n뉴스 세 가지", "Three stories\nyou need today"), fontSize: 86, fontWeight: 800, lineHeight: 1.22 }),
            text({ y: 80, text: T("2026. 7. 6 · 3분 읽기", "Jul 6, 2026 · 3 min read"), fontSize: 27, fontWeight: 400, color: WHITE_50 }),
          ],
        },
        {
          background: DIM.briefing(0.85, 0.68, 0.87),
          elements: [
            text({ y: 10, text: "1", fontSize: 96, fontWeight: 900, color: "#ff4d6d", lineHeight: 1 }),
            text({ y: 30, text: T("기준금리 동결,\n시장은 안도", "Rates on hold,\nmarkets exhale"), fontSize: 62, fontWeight: 800, lineHeight: 1.28 }),
            text({ y: 58, text: T("시장 예상과 일치하는 결정.\n연내 인하 기대는 여전히 유효합니다.", "Right in line with expectations —\nand a cut this year is still on the table."), fontSize: 34, fontWeight: 400, color: WHITE_70, lineHeight: 1.6 }),
          ],
        },
        {
          background: DIM.briefing(),
          elements: [
            text({ y: 34, text: T("내일 브리핑도\n놓치지 마세요", "Don't miss\ntomorrow's brief"), fontSize: 68, fontWeight: 800, lineHeight: 1.3 }),
            text({ y: 64, text: T("팔로우하고 매일 아침 받아보기 →", "Follow for your morning recap →"), fontSize: 34, fontWeight: 700, color: "#ff4d6d" }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          background: DIM.pop(),
          elements: [
            text({ y: 11, text: "NOTICE", fontSize: 27, fontWeight: 800, color: "#ffd60a" }),
            bar({ y: 16.5, w: 9, h: 0.7, color: "#ffd60a" }),
            text({ y: 26, text: T("7월 한정\n이벤트 오픈!", "July only —\ngiveaway is live!"), fontSize: 108, fontWeight: 900, lineHeight: 1.12 }),
            text({ y: 74, text: T("7. 7 — 7. 14 · 딱 일주일", "Jul 7 – 14 · one week only"), fontSize: 34, fontWeight: 700, color: "#ffd60a" }),
          ],
        },
        {
          background: DIM.pop(0.82, 0.66, 0.85),
          elements: [
            text({ y: 12, text: T("참여 방법", "How to enter"), fontSize: 30, fontWeight: 800, color: "#ffd60a" }),
            text({ y: 24, text: T("① 이 게시물 저장\n② 친구 태그\n③ 팔로우", "① Save this post\n② Tag a friend\n③ Follow us"), fontSize: 62, fontWeight: 800, lineHeight: 1.55 }),
            text({ y: 82, text: T("당첨자는 DM으로 안내드려요", "Winners announced by DM"), fontSize: 28, fontWeight: 400, color: WHITE_70 }),
          ],
        },
        {
          background: DIM.pop(),
          elements: [
            text({ y: 38, text: T("지금 바로\n참여하기 →", "Enter\nright now →"), fontSize: 96, fontWeight: 900, lineHeight: 1.2 }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          elements: [
            text({ y: 12, text: "GREEN HABIT", fontSize: 26, color: "#7ce3a8" }),
            bar({ y: 17.5, color: "#7ce3a8" }),
            text({ y: 26, text: T("제로웨이스트,\n오늘부터 가능한\n5가지", "Five zero-waste\nswaps you can\nstart today"), fontSize: 88, fontWeight: 800, lineHeight: 1.25 }),
            text({ y: 70, text: T("완벽하지 않아도 됩니다.\n하나씩만 바꿔보세요.", "You don't have to be perfect.\nJust swap one thing at a time."), fontSize: 34, fontWeight: 400, color: WHITE_70, lineHeight: 1.55 }),
          ],
        },
        {
          background: DIM.forest(0.82, 0.66, 0.86),
          elements: [
            text({ y: 9, text: "TIP 1", fontSize: 30, fontWeight: 800, color: "#7ce3a8" }),
            text({ y: 30, text: T("텀블러 하나로\n일년에 300개", "One tumbler,\n300 cups a year"), fontSize: 72, fontWeight: 800, lineHeight: 1.3 }),
            text({ y: 56, text: T("하루 한 잔 기준, 일회용 컵 300개를\n줄일 수 있어요.", "One coffee a day means ~300\ndisposable cups you never use."), fontSize: 36, fontWeight: 400, color: WHITE_70, lineHeight: 1.6 }),
          ],
        },
        {
          background: DIM.forest(),
          elements: [
            text({ y: 38, text: T("다음 팁이\n궁금하다면?", "Want the\nnext tip?"), fontSize: 80, fontWeight: 800, lineHeight: 1.3 }),
            text({ y: 66, text: T("저장 + 팔로우 🌱", "Save + follow 🌱"), fontSize: 38, fontWeight: 700, color: "#7ce3a8" }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          elements: [
            text({ y: 14, text: T("오늘의 문장", "Line of the day"), fontSize: 26, fontWeight: 700, color: "#ffb46b" }),
            text({ y: 28, text: T("“완벽한 시작은 없다.\n시작한 것이\n완벽해질 뿐이다.”", "“There is no perfect start.\nOnly starts that get\nperfected.”"), fontSize: 72, fontWeight: 800, color: "#f7f0e6", lineHeight: 1.4 }),
            text({ y: 82, text: T("— 어느 개발자의 회고에서", "— from a developer's retrospective"), fontSize: 28, fontWeight: 400, color: "rgba(247,240,230,0.6)" }),
          ],
        },
        {
          background: DIM.paper(0.84, 0.72, 0.88),
          elements: [
            text({ y: 14, text: T("이 문장을 고른 이유", "Why this line"), fontSize: 32, fontWeight: 800, color: "#ffb46b" }),
            text({ y: 28, text: T("미루는 이유의 대부분은\n‘아직 준비가 안 돼서’입니다.\n\n준비는 시작한 다음에\n하는 것이더라고요.", "Most procrastination hides behind\n“I'm not ready yet.”\n\nTurns out readiness is something\nyou build after you begin."), fontSize: 42, fontWeight: 400, color: "#f7f0e6", lineHeight: 1.65 }),
          ],
        },
        {
          background: DIM.paper(),
          elements: [
            text({ y: 40, text: T("매일 한 문장씩\n보내드립니다", "One line like this,\nevery single day"), fontSize: 64, fontWeight: 800, color: "#f7f0e6", lineHeight: 1.35 }),
            text({ y: 68, text: T("팔로우 →", "Follow →"), fontSize: 34, fontWeight: 700, color: "#ffb46b" }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          elements: [
            text({ y: 62, text: T("책상 하나로 시작한\n두 번째 직업", "A second career that\nstarted with one desk"), fontSize: 76, fontWeight: 800, lineHeight: 1.4 }),
            text({ y: 90, text: T("손으로 사는 사람들 ①", "People who work with their hands ①"), fontSize: 26, fontWeight: 400, color: "rgba(242,239,233,0.6)" }),
          ],
        },
        {
          elements: [
            { type: "image", x: 8, y: 6, w: 84, h: 40, src: "/templates/story.jpg", fit: "cover", radius: 2 },
            text({ y: 52, text: T("회사를 그만둔 날, 통장엔 석 달치 월세뿐.\n계획은 없었고, 대신 오래된 취미가 있었다.\n주말마다 만지던 나무였다.", "The day I quit, I had three months of rent saved.\nNo plan — just an old weekend habit:\nworking with wood."), fontSize: 37, fontWeight: 400, lineHeight: 1.7 }),
            text({ y: 76, text: T("잘하는 일 대신,\n오래 하고 싶은 일을 골랐다.", "I didn't pick what I was best at.\nI picked what I could do for decades."), fontSize: 40, fontWeight: 800, lineHeight: 1.6 }),
          ],
        },
        {
          elements: [
      ...
      cards: [
        {
          background: DIM.playbook("playbook-1.jpg"),
          elements: [
            text({ y: 12, text: "FIELD NOTES", fontSize: 27, fontWeight: 700, color: "#e9b8c4" }),
            text({ y: 24, text: T("멈추지 않는\n사람들의\n4가지 습관", "Four habits of\npeople who\nnever stall"), fontSize: 100, fontWeight: 800, lineHeight: 1.3 }),
            text({ y: 88, text: T("혼자 일하는 사람들을 위한 기록", "Notes for people who work alone"), fontSize: 27, fontWeight: 400, color: "rgba(246,239,228,0.65)" }),
          ],
        },
        {
          background: DIM.playbook("playbook-2.jpg", 0.8, 0.64, 0.9),
          elements: [
            text({ y: 20, text: T("결과 말고\n과정을 남겨라", "Log the process,\nnot the outcome"), fontSize: 82, fontWeight: 800, lineHeight: 1.35 }),
            text({ y: 48, text: T("완성작이 아니라,\n어제보다 나아진 한 줄.\n쌓인 기록이 다음 날의 연료다.", "Not the finished piece —\none line better than yesterday.\nThe log becomes tomorrow's fuel."), fontSize: 37, fontWeight: 400, lineHeight: 1.75, color: "rgba(246,239,228,0.85)" }),
            text({ y: 74, x: 60, w: 32, text: "1", fontSize: 170, fontWeight: 700, align: "right", lineHeight: 1, color: "rgba(246,239,228,0.9)" }),
          ],
        },
        {
          background: DIM.playbook("playbook-1.jpg", 0.82, 0.7, 0.92),
          elements: [
            text({ y: 38, text: T("나머지 세 가지 습관은", "The other three habits"), fontSize: 30, fontWeight: 400, color: "#e9b8c4" }),
            text({ y: 46, text: T("팔로우하고 이어보세요 →", "Follow to keep reading →"), fontSize: 64, fontWeight: 800, lineHeight: 1.4 }),
          ],
        },
      ],
    },
      ...
      cards: [
        {
          ...
          elements: [
            ...
            text({ y: 57, x: 8, w: 20, text: T("3분 정리 ⏱", "3-min read ⏱"), fontSize: 28, fontWeight: 700, color: "#ffffff", align: "center", lineHeight: 1.1 }),
            text({ y: 64, text: T("출근 전 30분,\n하루가 달라지는 루틴", "The 30-minute routine\nthat fixes your mornings"), fontSize: 74, fontWeight: 800, color: "#ffffff", lineHeight: 1.35 }),
            text({ y: 92, x: 8, w: 84, text: "@yourbrand", fontSize: 25, fontWeight: 600, color: "rgba(255,255,255,0.65)", align: "center" }),
          ],
        },
        {
          elements: [
            text({ y: 16, text: T("‘아침이 무너지면\n하루가 통째로 무너진다’", "“Lose the morning,\nlose the whole day.”"), fontSize: 46, fontWeight: 700, lineHeight: 1.6 }),
            text({ y: 40, text: T("거창한 미라클모닝 말고,\n지킬 수 있는 30분이면 충분해요.\n\n뭐부터 하면 될까요?", "Forget 5AM miracle routines.\nThirty minutes you can actually keep\nis all it takes.\n\nSo where do you start?"), fontSize: 37, fontWeight: 400, color: "#555555", lineHeight: 1.7 }),
            text({ y: 93, x: 8, w: 84, text: "@yourbrand", fontSize: 24, fontWeight: 600, color: "#9a9a9a", align: "center" }),
          ],
        },
        {
          elements: [
            text({ y: 12, x: 8, w: 11, text: "1.", fontSize: 62, fontWeight: 900, color: "#2563eb", lineHeight: 1 }),
            text({ y: 13, x: 19, w: 73, text: T("물 한 잔, 창문 열기", "Water first, window open"), fontSize: 48, fontWeight: 800, lineHeight: 1.2 }),
            text({ y: 28, text: T("몸을 깨우는 신호부터 시작해요.\n\n☀️ 물 한 잔 → 뇌에 시동 걸기\n🪟 환기 3분 → 밤새 무거워진 공기 리셋\n📵 폰 확인은 30분 뒤로", "Start with signals that wake the body.\n\n☀️ A glass of water → boots the brain\n🪟 3 min of fresh air → resets the room\n📵 Phone stays off for 30 more minutes"), fontSize: 37, fontWeight: 400, color: "#444444", lineHeight: 1.75 }),
            text({ y: 93, x: 8, w: 84, text: "@yourbrand", fontSize: 24, fontWeight: 600, color: "#9a9a9a", align: "center" }),
          ],
        },
      ],
